...
<div class="container">
    <div class="clearfix">
        <div class="section-title">
            <i class="logs-news-icon"></i> <span>Комментарии к новостям</span>
        </div>
        <!-- todo -->
        ...
        <?php if ( $this->role->opt_news_create ): ?>
            <?= CHtml::link('Добавить комментарий', array('create'), array(
    ...
    <div class="full-width-content">
        ...
        <?php $this->widget('zii.widgets.grid.CGridView', array(
            ...
            'filter'=>$model,
            //'filterCssClass'=>'data-header filters',
            ...
            'columns'=>array(
                ...
                array(
                    'name'=>'news_id',
                    'value'=>'CHtml::link($data->news->title, array("/cabinet/news/view", "id"=>$data->news_id))',
                    'sortable'=>false,
                    'type'=>'raw',
                    'filter'=>CHtml::listData(News::items(), 'id', 'value'),
                ),
                array(
                    'name'=>'user_id',
                    'value'=>'CHtml::link($data->user->login, array("/cabinet/user/view", "id"=>$data->user_id))',
                    'sortable'=>false,
                    'type'=>'raw',
                    'filter'=>CHtml::listData(User::items(), 'id', 'value'),
                ),
