...
<div class="container">
    <div class="clearfix">
        <div class="section-title">
            <i class="logs-news-icon"></i> <span>Обратная связь (запросы от пользователей)</span>
        </div>
        <!-- todo -->
        ...
        <!-- -->
        <?php if ( 0 ): ?>
            <?= CHtml::link('Создать запрос', array('create'), array(
    ...
    <div class="full-width-content">
        ...
        <?php $this->widget('zii.widgets.grid.CGridView', array(
            ...
            'columns'=>array(
                ...
                array(
                    'name'=>'email',
                    'value'=>'CHtml::link($data->email, "mailto:".$data->email, array("target"=>"_blank"))',
                    'type'=>'raw',
                ),
                'phone',
                array(
